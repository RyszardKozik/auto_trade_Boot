...
if TRADING_MODE == "live":
    API_KEY = os.getenv("LIONHEART2_LIVE_API_KEY")
    API_SECRET = os.getenv("LIONHEART2_LIVE_SECRET_KEY")
    BASE_URL = os.getenv("LIONHEART2_LIVE_BASE_URL", "https://api.alpaca.markets")
    logger.info("Running in LIVE mode.")
else:
    API_KEY = os.getenv("LIONHEART2_API_KEY")
    API_SECRET = os.getenv("LIONHEART2_SECRET_KEY")
    BASE_URL = os.getenv("LIONHEART2_BASE_URL", "https://paper-api.alpaca.markets")
